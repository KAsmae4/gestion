...
/**
 * REST controller for managing {@link com.kchaimae.domain.ChefService}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ChefServiceResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/chef-services/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<ChefService> partialUpdateChefService(
        ...
        Optional<ChefService> result = chefServiceRepository
            ...
            .map(existingChefService -> {
                if (chefService.getNom() != null) {
                    existingChefService.setNom(chefService.getNom());
                }
                if (chefService.getPrenom() != null) {
                    existingChefService.setPrenom(chefService.getPrenom());
                }
                if (chefService.getTelephone() != null) {
                    existingChefService.setTelephone(chefService.getTelephone());
                }
    ...
    public ResponseEntity<List<ChefService>> getAllChefServices(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
