...
describe('TypeFormation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'type-formation', component: TypeFormationComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.typeFormations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to typeFormationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTypeFormationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTypeFormationIdentifier).toHaveBeenCalledWith(entity);
