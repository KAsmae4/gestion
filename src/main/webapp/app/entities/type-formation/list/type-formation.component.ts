...
import { EntityArrayResponseType, TypeFormationService } from '../service/type-formation.service';
...
export class TypeFormationComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITypeFormation): number => this.typeFormationService.getTypeFormationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.typeFormations = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ITypeFormation[] | null): ITypeFormation[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.typeFormationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
