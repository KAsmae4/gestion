...
import { IGroupedTypeFormation, ITypeFormation, NewTypeFormation } from '../type-formation.model';
...
export class TypeFormationService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/type-formations');
  ...
  queryAll(): Observable<HttpResponse<IGroupedTypeFormation[]>> {
    return this.http.get<IGroupedTypeFormation[]>(`${this.resourceUrl}/all`, { observe: 'response' });
  }
