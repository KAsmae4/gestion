...
import { EntityArrayResponseType, TypeServiceService } from '../service/type-service.service';
...
export class TypeServiceComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITypeService): number => this.typeServiceService.getTypeServiceIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.typeServices = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ITypeService[] | null): ITypeService[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.typeServiceService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
