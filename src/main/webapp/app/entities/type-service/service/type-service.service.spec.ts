...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../type-service.test-samples';
...
describe('TypeService Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a TypeService', () => {
      ...
      service.create(typeService).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a TypeService', () => {
      ...
      service.update(typeService).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addTypeServiceToCollectionIfMissing', () => {
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(typeService);
        expect(expectedResult).toContain(typeService2);
      });
